...
# Program memiliki 2 role: Manager (akses penuh CRUD) dan Karyawan (hanya Read dan Update Status)
# Semua variabel dan fungsi menggunakan nama dalam bahasa Indonesia
